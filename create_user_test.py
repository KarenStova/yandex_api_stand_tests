...
# Функция для проверки отсуствия передачи данных
...
# Тест 4. Количество символов меньше допустимого
...
# Параметр fisrtName состоит из англ. символов
def test_create_user_en_letters_in_first_name_get_success_response():
    positive_assert("QWErty")

# Тест 6. Разрешены русские буквы
# Параметр fisrtName состоит из русск. символов
def test_create_user_ru_letters_in_first_name_get_success_response():
...
def test_create_user_has_special_symbol_first_name_get_success_response():
    negative_assert_symbol("№%@")

# Тест 9. Запрещены пробелы
# Параметр fisrtName содержит пробелы
def test_create_user_has_numbers_in_first_name_get_success_response():
...
# Параметр fisrtName передан как число, а не как строка
def test_create_user_number_type_first_name_get_success_response():
